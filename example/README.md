_Warning: This README was mostly generated by Sonnet._

_Warning: All of this code was generated by Sonnet, and I tried to avoid looking at it._
...
6. **Command Line Arguments**: Parsing and using command line arguments to control execution
7. **Computational Complexity Analysis**: Understanding the performance implications of different execution models
8. **Rust Option Type**: Using Rust's `Option` type to express the semantics of operations that may or may not produce a result
